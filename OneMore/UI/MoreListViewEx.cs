...
namespace River.OneMoreAddIn.UI
{
	...
	/// </summary>
	internal class MoreListViewEx : ListView
	{
		...
		protected override void OnItemDrag(ItemDragEventArgs e)
		{
			...
			DoDragDrop(nameof(MoreListViewEx), DragDropEffects.Move);
		}
		...
		protected override void OnDragOver(DragEventArgs drgevent)
		{
			...
			if (text.CompareTo(nameof(MoreListViewEx)) == 0)
			{
	...
	internal class MoreHostedListViewItem : ListViewItem, IMoreHostItem
	{
		...
		public MoreHostedListViewSubItem AddHostedSubItem(string text, Control control)
		{
			...
			{
				Registering(subitem,
					new MoreListViewEx.RegistrationEventArgs(this, control, SubItems.Count));
			}
		...
		/// For internal use only.
		/// </summary>
		public event MoreListViewEx.RegistrationEventHandler Registering;
