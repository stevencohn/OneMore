...
CREATE TABLE IF NOT EXISTS favorites_schema (schemaID INTEGER PRIMARY KEY UNIQUE NOT NULL, version NUMERIC (12) UNIQUE NOT NULL);
...
REPLACE INTO favorites_schema (schemaID, version) VALUES (0, 2);
