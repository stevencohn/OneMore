...
namespace River.OneMoreAddIn.Commands
{
	partial class AdjustImagesDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.storageLabel = new UI.MoreLabel();
			this.storedSizeLabel = new UI.MoreLabel();
			...
			this.saturationLabel = new UI.MoreLabel();
			this.saturationBox = new River.OneMoreAddIn.UI.MoreNumericUpDown();
			this.limitsBox = new UI.MoreComboBox();
		...
		private UI.MoreLabel saturationLabel;
		private UI.MoreNumericUpDown saturationBox;
		private UI.MoreComboBox limitsBox;
