namespace River.OneMoreAddIn.Commands
{
	partial class PluginDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.cmdLabel = new UI.MoreLabel();
			...
			this.timeoutLabel = new UI.MoreLabel();
			this.targetBox = new UI.MoreComboBox();
			this.targetLabel = new UI.MoreLabel();
			...
			this.userArgsLabel = new UI.MoreLabel();
		...
		private UI.MoreLabel argsLabel;
		private UI.MoreButton browseArgsButton;
		private UI.MoreButton saveButton;
		private UI.MoreLabel pluginsLabel;
		private UI.MoreComboBox pluginsBox;
		...
		private UI.MoreLabel timeoutLabel;
		private UI.MoreComboBox targetBox;
		...
		private UI.MoreLabel userArgsLabel;
