namespace River.OneMoreAddIn.Commands
{
	partial class ScanDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.scannerBox = new UI.MoreComboBox();
			...
			this.resolutionBox = new UI.MoreComboBox();
			this.colorLabel = new River.OneMoreAddIn.UI.MoreLabel();
			this.colorBox = new UI.MoreComboBox();
			this.sizeBox = new UI.MoreComboBox();
			this.sourceBox = new UI.MoreComboBox();
			this.profileBox = new UI.MoreComboBox();
		...
		private UI.MoreComboBox scannerBox;
		private UI.MorePanel contentPanel;
		private UI.MoreComboBox sourceBox;
		private UI.MoreComboBox profileBox;
		...
		private UI.MoreComboBox resolutionBox;
		private UI.MoreLabel colorLabel;
		private UI.MoreComboBox colorBox;
