...
CREATE TABLE IF NOT EXISTS hashtag_notebook (notebookID TEXT PRIMARY KEY, name TEXT, included INTEGER NOT NULL DEFAULT 1 CHECK (included IN (0, 1)), lastModified TEXT NOT NULL DEFAULT '');
