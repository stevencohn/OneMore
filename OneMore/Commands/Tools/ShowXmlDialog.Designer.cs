namespace River.OneMoreAddIn.Commands
{
	partial class ShowXmlDialog
	{
		...
		private void InitializeComponent ()
		{
			...
			this.pageBox = new River.OneMoreAddIn.UI.MoreRichTextBox();
			this.sectionTab = new System.Windows.Forms.TabPage();
			this.sectionBox = new River.OneMoreAddIn.UI.MoreRichTextBox();
			this.notebooksTab = new System.Windows.Forms.TabPage();
			this.notebookBox = new River.OneMoreAddIn.UI.MoreRichTextBox();
			this.nbSectionsTab = new System.Windows.Forms.TabPage();
			this.nbSectionBox = new River.OneMoreAddIn.UI.MoreRichTextBox();
			this.nbPagesTab = new System.Windows.Forms.TabPage();
			this.nbPagesBox = new River.OneMoreAddIn.UI.MoreRichTextBox();
			this.manualTab = new System.Windows.Forms.TabPage();
			this.manualBox = new River.OneMoreAddIn.UI.MoreRichTextBox();
		...
		private UI.MoreRichTextBox pageBox;
		private UI.MoreRichTextBox manualBox;
		...
		private UI.MoreRichTextBox sectionBox;
		private UI.MoreRichTextBox notebookBox;
		private UI.MoreRichTextBox nbSectionBox;
		private UI.MoreRichTextBox nbPagesBox;
