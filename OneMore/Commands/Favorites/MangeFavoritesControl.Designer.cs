...
{
	partial class MangeFavoritesControl
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.newFolderButton = new River.OneMoreAddIn.UI.MoreMenuItem();
			...
			this.sortButton.ToolTipText = "Sort current folder";
			...
			this.newFolderButton.Image = global::River.OneMoreAddIn.Properties.Resources.m_FolderClose;
			this.newFolderButton.Name = "newFolderButton";
			this.newFolderButton.Size = new System.Drawing.Size(40, 29);
			this.newFolderButton.ToolTipText = "New Folder";
			this.newFolderButton.Click += new System.EventHandler(this.CreateFolder);
			//
			// toolStripSeparator3
			//
			...
			this.renameMenuItem.Text = "Rename Favorite";
			this.renameMenuItem.Click += new System.EventHandler(this.RenameSelected);
			//
			// FavoritesManagerControl
			//
			this.Controls.Add(this.listView);
			this.Controls.Add(this.toolStrip);
			this.Dock = System.Windows.Forms.DockStyle.Fill;
			this.Name = "FavoritesManagerControl";
		...
		private River.OneMoreAddIn.UI.MoreMenuItem newFolderButton;
