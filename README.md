...
## Languages
OneMore is translated to Arabic, Chinese Simplified, Dutch, English, French, German, Portuguese, and Spanish. Please let me know if you'd like it translated to another language. I used my [ResxTranslator](https://github.com/stevencohn/ResxTranslator) program to automate the translations but can also override inaccuracies with specific words and phrases. If think a translation is not correct, also please let me know.
